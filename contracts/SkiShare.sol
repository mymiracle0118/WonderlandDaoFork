...
contract SkiShare is ERC20Burnable, Operator {
    ...
    uint256 public constant FARMING_POOL_REWARD_ALLOCATION = 60000 * 1e18;
    uint256 public constant COMMUNITY_FUND_POOL_ALLOCATION = 0 * 1e18;
    uint256 public constant DEV_FUND_POOL_ALLOCATION = 5000 * 1e18;
    ...
    constructor(uint256 _startTime, address _communityFund, address _devFund) public ERC20("SKISHARES", "SKISHARE Token") {
        _mint(msg.sender, 1e18); // mint 1 TOMB Share for initial pools deployment
